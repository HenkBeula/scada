...
const consumed_water = document.getElementById('consumed_water');
const cost = document.getElementById('cost');

consumed_water.addEventListener('input', (e) => {
    cost.textContent = Math.round((e.target.value * 12.4) + Number.EPSILON) + " MZN";
});
