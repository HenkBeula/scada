...
// Get the modal
var modal = document.getElementById('mpesa');
...
function div_showE(){
	document.getElementById('emola').style.display ="block";
}

// 
function closeFormE(){
	document.getElementById('emola').style.display ="none";
}
...
function calc_consup(){
	var cons = document.getElementById("consumed_water").value;
	total = cons*2.7;
	document.getElementById("cash").addEventListener('input', total, true);
}